...
# (Importante para o seu trabalho em Belém)
...
# Seção de Gestão de Risco (Sem o bloco 'with' para evitar erros de espaço)
st.sidebar.header("💰 Gestão de Banca")
banca_input = st.sidebar.number_input("Sua Banca Total (R {financeiro_risco:.2f}")
